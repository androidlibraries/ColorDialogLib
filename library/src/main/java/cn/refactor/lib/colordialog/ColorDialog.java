...
public class ColorDialog extends Dialog implements View.OnClickListener {
	...
	private OnLongClickContentListener mOnLongClickContentListener;
	...
	public void setOnLongClickContentListener(
			OnLongClickContentListener OnLongClickContentListener) {
		this.mOnLongClickContentListener = OnLongClickContentListener;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View contentView = View.inflate(getContext(),
				R.layout.layout_colordialog, null);
		...
		mContentTv.setOnLongClickListener(new OnLongClickListener() {

			@Override
			public boolean onLongClick(View v) {
				if (mOnLongClickContentListener != null) {
					mOnLongClickContentListener.onLongClick();
				}
				return true;
			}
		});
		...
		if (null == mPositiveListener && null == mNegativeListener) {
			...
			mNegativeBtn.setBackgroundDrawable(getContext().getResources()
					.getDrawable(R.drawable.sel_def_gray));
		} else if (null != mPositiveListener && null == mNegativeListener) {
	 ...
	 * @return
	 */
	public ColorDialog setCancelDialogable(boolean enable) {
	...
	public ColorDialog setPositiveListener(CharSequence text,
	...
	public ColorDialog setNegativeListener(CharSequence text,
	...
	public interface OnLongClickContentListener {
		void onLongClick();
	}
}
